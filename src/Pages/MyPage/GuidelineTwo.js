  ...
  const handleHome = () => {
    ...
    return(
        <div className={styles['container']}>
            <Text text1="편지를 많이 쓰면" span="고봉이" text3="에게 편지가 와요!" subtext="편지 카드가 점점 더 업그레이드 되는 재미가 있어요 :)"/>
            <img src="/images/guide.png" className={styles['img']} style={{marginRight:"1.5vw"}}/>
